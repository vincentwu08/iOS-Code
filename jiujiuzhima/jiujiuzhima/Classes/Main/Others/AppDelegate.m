...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    TGTabBarViewController *tabbarVc = [[TGTabBarViewController alloc] init];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "play.hansen.___" in the application's documents directory.
